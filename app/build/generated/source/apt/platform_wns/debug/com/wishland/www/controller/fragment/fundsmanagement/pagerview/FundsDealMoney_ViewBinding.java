...
public class FundsDealMoney_ViewBinding implements Unbinder {
  private FundsDealMoney target;
  ...
  @UiThread
  public FundsDealMoney_ViewBinding(final FundsDealMoney target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FundsDealMoney target = this.target;
